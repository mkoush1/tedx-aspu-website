...
const BackgroundPattern = () => {
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      ...
      {/* Premium luxury radial gradients - Apple style */}
      ...
      {/* Subtle animated particles - Apple inspired */}
      ...
      {/* Luxury diagonal line element - Apple inspired */}
...
export const ScrollAnimation = ({ children, animation = 'fade-up', delay = 0, threshold = 0.1, className = '' }) => {
  ...
  return (
    <div
      ref={domRef}
      className={`${className} ${animationClasses[animation] || animationClasses['fade-up']} ${isVisible ? visibleClasses[animation] || visibleClasses['fade-up'] : ''}`}
      style={{ 
