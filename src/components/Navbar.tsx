        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <button 
              ...
              className={`h-8 md:h-10 transition-all duration-300 transform ${isScrolled ? 'scale-90' : 'scale-100'} relative group`}
            >
              ...
              <img 
                ...
                alt="TEDxASPU Logo"
                className="h-full w-auto drop-shadow-[0_0_12px_rgba(229,69,69,0.5)] relative z-10"
              />
            </button>
            ...
            <div className="hidden md:flex items-center space-x-2 lg:space-x-4">
              ...
              <button
                ...
                className="relative ml-1 px-5 py-2 text-white text-sm lg:text-base font-medium rounded-full group overflow-hidden"
              >
                <span className="absolute inset-0 bg-gradient-to-r from-red-700 to-red-800 group-hover:from-red-800 group-hover:to-red-900 transition-colors duration-300"></span>
      ...
      >
        <div className="w-full max-w-md px-6 flex flex-col items-center justify-center space-y-6">
          ...
          <button
            onClick={() => scrollToSection('tickets')}
            className={`
              mt-4 px-8 py-3 bg-red-700 hover:bg-red-800 text-white text-lg font-medium rounded-full
